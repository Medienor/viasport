...
function getNextSunday(): Date {
  ...
  // Calculate days until next Sunday (if today is Sunday, get next Sunday)
  const daysUntilSunday = dayOfWeek === 0 ? 7 : (7 - dayOfWeek);
  
  // If it's already Sunday and we want this Sunday instead of next, use this:
...
export default async function SundayPage() {
  // Get next Sunday's date in YYYY-MM-DD format
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex flex-col md:flex-row-reverse gap-8">
        ...
        {/* Right column - Sunday's fixtures by league - Now first on mobile, second on desktop */}
